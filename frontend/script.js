...
const MAPS={
  ...
  landslide_occ:{
    ...
    floatLegend(){return`<div class="lf-title">Landslide Occurred</div>
  ...
  detection:{
    ...
    floatLegend(){return`<div class="lf-title">Detection Source</div>
  ...
  soil:{
    ...
    floatLegend(){return`<div class="lf-title">Soil: <span id="soilMode">Clay %</span></div>
  ...
  river:{
    ...
    floatLegend(){return`<div class="lf-title">River Dist (km)</div>${gradBar('linear-gradient(90deg,#ffdc00,#ff1e50)','0 km','5 km','10+ km')}
